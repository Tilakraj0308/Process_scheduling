...
public class Processes {
	...
	private void print_averages() {
		...
		System.out.println("Average Tat : " + (avgTat/n) + "ms");
		System.out.println("Average Wt : " + (avgWt/n) + "ms");
		System.out.println("Average Rt : " + (avgRt/n) + "ms");
	}
	
	private int prmtiv_processing(Process temp, int curr, ArrayList<Process> gantt, int tq) {
		if(!temp.hasHit()) {
	...
	private int prmtiv_processing(Process temp, int curr, ArrayList<Process> gantt) {
		if(!temp.hasHit()) {
			temp.setRt(curr - temp.getAr());
			temp.setHasHit(true);
		}
	...
	private int non_prmtiv_processing(Process temp, int curr, ArrayList<Process> gantt_rec) {
	...
	private void present(ArrayList<Process> gantt) {
		printGanttchart(gantt);
		print_table();
		print_averages();
	}
	private void printGanttchart(ArrayList<Process> gantt) {
